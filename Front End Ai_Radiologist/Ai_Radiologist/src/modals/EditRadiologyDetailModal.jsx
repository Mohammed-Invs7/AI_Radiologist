...
const EditRadiologyDetailModal = ({
  show,
  onClose,
  onSave,
  value,
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Edit Radiology Detail</h5>
            <button
              type="button"
              className="btn-close"
              onClick={onClose}
          ...
          <div className="modal-footer">
            ...
            <button
              ...
              onClick={() => {
                onSave(); // Save changes when clicked
...
export default EditRadiologyDetailModal;

...
EMAIL_CONFIRM_REDIRECT_BASE_URL = FRONT_END_HOST + "AI_Radiologist/verify-email/"
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = EMAIL_CONFIRM_REDIRECT_BASE_URL
# <PASSWORD_RESET_CONFIRM_REDIRECT_BASE_URL>/<uidb64>/<token>/
PASSWORD_RESET_CONFIRM_REDIRECT_BASE_URL = FRONT_END_HOST + "AI_Radiologist/reset-password/"
...
LOGIN_URL = FRONT_END_HOST + 'AI_Radiologist/login' # "/api/v1/auth/login/"  # Path, users will be redirected to after email verification
